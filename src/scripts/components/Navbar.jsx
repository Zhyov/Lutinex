...
export default function Navbar({ gridEnabled, searchEnabled, filterEnabled, search, setSearch, gridCols, setGridCols, setFilterParam }) {
    ...
    const changeFilter = filterEnabled ? "block" : "hidden"
    ...
    return (
        <nav className="p-4 h-18 sticky top-0 z-1 backdrop-blur flex flex-nowrap flex-row justify-center items-center w-full bg-dark/40 shadow-md border-b-1 border-b-neutral-800" >
            <div className="flex flex-nowrap flex-row basis-auto gap-x-1 items-center mr-auto">
                <Link to="/Lutinex/">
                    <img src="https://zhyov.github.io/Lutinex/assets/title.svg" alt="logo" className="size-16 mr-4 invert" />
                </Link>
                <div>
                    <button onClick={() => setOpenMenu(openMenu === "language" ? null : "language")} className={`flex flex-nowrap flex-row gap-x-2 p-2 hover:cursor-pointer rounded-md items-center transition-colors hover:bg-neutral-800 hover:*:invert-0 ${hideOrNot}`}>
                ...
                <div>
                    <button onClick={() => setOpenMenu(openMenu === "country" ? null : "country")} className={`flex flex-nowrap flex-row gap-x-2 p-2 hover:cursor-pointer rounded-md items-center transition-colors hover:bg-neutral-800 hover:*:invert-0 ${hideOrNot}`}>
                        <span className="text-[16px] text-white invert-50">Country</span>
                    </button>
                    {openMenu === "country" && (
                        <div className="absolute -translate-x-1/16 translate-y-16 flex flex-nowrap flex-col items-center top-0 rounded-sm ring-1 w-20 ring-neutral-800 bg-dark">
                            <div className="flex flex-nowrap flex-col w-full">
                                ...
                                <Link to="/Lutinex/users" className={hideOrNot}>
                                    <div className="flex flex-nowrap flex-row gap-x-2 p-2 rounded-md items-center justify-center transition-colors hover:bg-neutral-800 hover:*:invert-0">
                                        <span className="text-[16px] text-white invert-50">Users</span>
                                    </div>
                                </Link>
                            </div>
                        </div>
            ...
            {
                searchEnabled
                ? <div className="flex flex-nowrap flex-row basis-8/10 md:basis-5/10 gap-x-2 justify-end">
                    <div>
                    ...
                    <div>
                        ...
                        {openMenu === "grid" && (
                            <div className="absolute -translate-x-11/32 translate-y-16 flex flex-nowrap flex-col items-center top-0 rounded-sm ring-1 w-30 ring-neutral-800 bg-dark">
                ...
                :   
                <div className="flex flex-nowrap flex-row basis-4/10 gap-x-2 justify-end">
                    {
                        !token ? (
                            <>
                                <Link to="/Lutinex/signin" className={hideOrNot}>
                                    <div className="flex flex-nowrap flex-row gap-x-2 p-2 rounded-md items-center transition-colors hover:bg-neutral-800 hover:*:invert-0">
                                        <span className="text-[16px] text-white invert-50">Sign In</span>
                                    </div>
                                </Link>
                                <Link to="/Lutinex/signup" className={hideOrNot}>
                                    <div className="flex flex-nowrap flex-row gap-x-2 p-2 rounded-md items-center transition-colors hover:bg-neutral-800 hover:*:invert-0">
                                        <span className="text-[16px] text-white invert-50">Sign Up</span>
                                    </div>
                                </Link>
                            </>
                        ) : (
                            <Link to={`/Lutinex/users/${user?.username}`} className={hideOrNot}>
                                <div className="flex flex-nowrap flex-row gap-x-2 p-2 rounded-md items-center transition-colors hover:bg-neutral-800 hover:*:invert-0">
                                    <span className="text-[16px] text-white invert-50">Profile</span>
                                </div>
                            </Link>
                        )
                    }
